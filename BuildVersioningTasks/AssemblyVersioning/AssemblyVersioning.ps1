...
# Input parameter from build task
[int]$digitsSetInAssemblyVersion = Get-VstsInput -Name "digitsSetInAssemblyVersion" -Require
[string]$infoversionpostfix = Get-VstsInput -Name "infoversionpostfix"
